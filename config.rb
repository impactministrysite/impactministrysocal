...
# proxy program.yml files to program.html
data.programs.each do |_filename, program|
  # program is an array: [filename, {data}]
  proxy "/program/#{program[:title].parameterize}/index.html", "program.html",
